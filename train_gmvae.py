...
# python train_gmvae.py -o ./checkpoints -l ./logs --n_gpus 1 --hparams "training_files=['filelists/mcv_train_filelist.txt','filelists/vctk_train_filelist.txt','filelists/ljs_train_filelist.txt'],validation_files=['filelists/mcv_val_filelist.txt','filelists/vctk_val_filelist.txt','filelists/ljs_val_filelist.txt'],batch_size=64,iters_per_checkpoint=1000,load_spect_from_disk=True,clip_long_targets=512,symbols_embedding_dim=32,encoder_embedding_dim=256,decoder_rnn_dim=512,prenet_dim=128,mse_weight=1,gate_weight=1,marginal_ykld_weight=0,ykld_weight=1,learn_sigma_x=True,min_sigma_x=0.03"
