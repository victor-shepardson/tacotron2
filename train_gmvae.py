...
# python train_gmvae.py -o ./checkpoints -l ./logs --n_gpus 1 --hparams "training_files='filelists.0729/mcv_train_filelist.txt',validation_files='filelists.0729/mcv_val_filelist.txt',batch_size=64,iters_per_checkpoint=1000,load_spect_from_disk=True,clip_long_targets=512,symbols_embedding_dim=32,encoder_embedding_dim=256,decoder_rnn_dim=512,prenet_dim=128,mse_weight=10,gate_weight=100,marginal_ykld_weight=0,ykld_weight=1,learn_sigma_x=True,min_sigma_x=0.03" --c checkpoints.1/checkpoint_200000 --warm_start
