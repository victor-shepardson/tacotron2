...
# CPU test:
# python train_cond.py -o ./checkpoints -l ./logs --n_gpus 0 --hparams "training_files='filelists/mcv_train_single.txt',validation_files='filelists/mcv_val_single.txt',batch_size=1,iters_per_checkpoint=5,load_mel_from_disk=True,n_speakers=14,speaker_embedding_dim=32,n_languages=2,language_embedding_dim=32,text_cleaners=['transliteration_cleaners'],symbols_embedding_dim=128,encoder_n_convolutions=4"
